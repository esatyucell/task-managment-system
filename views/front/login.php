    ...
    <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7 col-sm-9">
            <div class="bg-white rounded shadow-sm p-5" style="transition: all 0.3s ease;">
                <h2 class="mb-4 text-center" style="color: #222; font-family: 'Quicksand', sans-serif;">Giriş Yap</h2>
                ...
                <form method="post" action="/login" autocomplete="off">
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center gap-2 mt-4">
                        <button type="submit" class="btn btn-primary rounded-3 px-4 py-2 w-100 w-sm-auto">Giriş Yap</button>
                        <a href="/register" class="btn btn-outline-secondary rounded-3 px-4 py-2 w-100 w-sm-auto">Kayıt Ol</a>
                    </div>
                </form>

                <p class="text-center mt-3" style="font-size: 14px; color: #666;">
                    Henüz hesabınız yok mu? <a href="/register" style="text-decoration: none;">Kayıt Ol</a>
                </p>
            </div>
        </div>
    </div>
